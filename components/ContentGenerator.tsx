      ...
      <div className="flex items-center justify-between mb-6 pb-6 border-b border-slate-200">
        ...
        <div className="bg-slate-100 p-1 rounded-lg flex gap-1">
          <Button
            ...
            className={
              activeTab === "quick" ? "bg-white text-slate-900 shadow-sm" : ""
            }
          >
            Quick Post
          </Button>
          ...
          <Button
            ...
            className={
              activeTab === "seo" ? "bg-white text-slate-900 shadow-sm" : ""
            }
            icon={
              <Search
                size={14}
                className={activeTab === "seo" ? "text-indigo-500" : ""}
              />
            }
          >
            SEO
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 flex-1 overflow-hidden">
        ...
        <div className="minimal-card p-6 overflow-y-auto custom-scrollbar flex flex-col h-full">
          <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm">
              {activeTab === "quick"
                ...
                : activeTab === "campaign"
                  ? "Define goals for strategic reasoning."
                  : activeTab === "seo"
                    ? "Find high-value keywords and gaps."
              ...
              <>
                ...
                <div className="p-4 bg-indigo-50 border border-indigo-100 rounded-lg">
                  ...
                  <p className="text-xs text-indigo-600/80">
                    Gemini 3 Pro will analyze search intent and difficulty to
                    suggest high-value opportunities.
                  </p>
                </div>
              </>
            )}
            ...
            {activeTab === "optimize" && (
              <>
                ...
                <Select
                  ...
                  options={[
                    {
                      label: "Make it more engaging and viral",
                      value: "Make it more engaging and viral",
                    },
                    {
                      label: "Fix grammar and professionalize tone",
                      value: "Fix grammar and professionalize tone",
                    },
                    {
                      label: "Shorten and make punchy",
                      value: "Shorten and make punchy",
                    },
                    {
                      label: "Expand and add detail",
                      value: "Expand and add detail",
                    },
                    {
                      label: "Optimize for SEO keywords",
          ...
          <Button
            ...
            icon={
              isThinkingMode ? <BrainCircuit size={18} /> : <Wand2 size={18} />
            }
            fullWidth
            className="mt-6"
                ...
                <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                  ...
                  <div className="divide-y divide-slate-100">
                    ...
                    {seoResult.keywords.map((kw, i) => (
                      <div
                        key={i}
                        className="grid grid-cols-4 px-6 py-3 text-sm hover:bg-slate-50 transition-colors"
                      >
                  ...
                  <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                    ...
                    <ul className="space-y-2">
                      {seoResult.competitorUrls.map((url, i) => (
                        <li
                          key={i}
                          className="flex gap-2 text-sm text-slate-600 truncate"
                        >
