...
const CampaignManager = lazy(() => import('./components/CampaignManager').then(m => ({ default: m.CampaignManager })));
...
const AudienceBuilder = lazy(() => import('./components/AudienceBuilder').then(m => ({ default: m.AudienceBuilder })));
